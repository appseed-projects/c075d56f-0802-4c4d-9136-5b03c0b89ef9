...
Open-source **Flask/Jinja Template** generated by `AppSeed` op top of **[AdminLTE](https://appseed.us/product/adminlte/)**, an iconic dashboard design. The project is a super simple Flask project WITHOUT database, ORM, or any other hard dependency. The project can be used as a codebase for future project or to migrate the Jinja files and assets to a legacy Python-based project that uses Jinja as template engine (Flask, Bottle, Django).
...
- Timestamp: `2022-05-13 05:29`
- Build ID: `c075d56f-0802-4c4d-9136-5b03c0b89ef9`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/c075d56f-0802-4c4d-9136-5b03c0b89ef9.git
$ cd c075d56f-0802-4c4d-9136-5b03c0b89ef9
```
...
---
AdminLTE Flask/Jinja - Open-source starter generated by **[AppSeed Generator](https://appseed.us/generator/)**.
